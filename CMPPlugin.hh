...
/// as described in arXiv:2205.11879
...
public:
 ...
 /// definition of ktmax
 ///   0 : dynamic ktmax (pT of the hardest pseudojet lying around)
 ...
 CMPPlugin(double R, double a, CorrectionType correction_type, ClusteringType clustering_type, bool spherical=false)
     : _R(R), _a(a), _correction_type(correction_type), _clustering_type(clustering_type), _spherical(spherical) {}
